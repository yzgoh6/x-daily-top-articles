...
CATEGORIES = {
    "AI": {
        ...
        "search_queries": [
            ...
            "from:OpenAI lang:en",
            "from:AnthropicAI lang:en",
            "from:GoogleDeepMind lang:en",
            "from:xaboratory lang:en",
            "from:DeepSeek lang:en",
            "from:MistralAI lang:en",
            "from:MetaAI lang:en",
            "from:huggingface lang:en",
            "from:stability_ai lang:en",
            "from:midjourney lang:en",
            "from:CohereAI lang:en",
            "from:ElevenLabs lang:en",
            "from:perplexity_ai lang:en",
            "from:cursor_ai lang:en",
        ],
    },
    "Tech": {
        "priority": 2,
    ...
    "Finance": {
        ...
        "search_queries": [
            ...
            "from:business lang:en",
            "from:Reuters lang:en",
            "from:CNBC lang:en",
            "from:WSJ lang:en",
            "from:MarketWatch lang:en",
            "from:FT lang:en",
            "from:TheEconomist lang:en",
            "from:federalreserve lang:en",
            "from:NYSE lang:en",
            "from:YahooFinance lang:en",
            "from:Barchart lang:en",
        ],
    },
    "Business": {
        "priority": 5,
