...
CATEGORIES = {
    "AI": {
        ...
        "search_queries": [
            ...
            "from:OpenAI lang:en min_faves:50",
            "from:AnthropicAI lang:en min_faves:50",
            "from:GoogleDeepMind lang:en min_faves:50",
            "from:xaboratory lang:en min_faves:50",
            "from:DeepSeek lang:en min_faves:50",
            "from:MistralAI lang:en min_faves:50",
            "from:MetaAI lang:en min_faves:50",
            "from:huggingface lang:en min_faves:50",
            "from:stability_ai lang:en min_faves:50",
            "from:midjourney lang:en min_faves:50",
            "from:CohereAI lang:en min_faves:50",
            "from:ElevenLabs lang:en min_faves:50",
    ...
    "Finance": {
        ...
        "search_queries": [
            ...
            "from:business lang:en min_faves:50",
            "from:Reuters lang:en min_faves:50",
            "from:CNBC lang:en min_faves:50",
            "from:WSJ lang:en min_faves:50",
            "from:MarketWatch lang:en min_faves:50",
            "from:FT lang:en min_faves:50",
            "from:TheEconomist lang:en min_faves:50",
            "from:federalreserve lang:en min_faves:50",
            "from:NYSE lang:en min_faves:50",
